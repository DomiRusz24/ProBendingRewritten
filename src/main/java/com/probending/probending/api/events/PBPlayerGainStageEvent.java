...
public class PBPlayerGainStageEvent extends PBPlayerUpdateStageEvent implements Cancellable {

    private boolean canceled = false;

    public PBPlayerGainStageEvent(ActiveArena arena, ArenaState state, ActivePlayer player, Ring currentStage, int ringOffset) {
